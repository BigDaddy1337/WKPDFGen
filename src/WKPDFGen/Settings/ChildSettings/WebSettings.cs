...
namespace WKPDFGen.Settings.ChildSettings
{
    public class WebSettings : IUserSettings
    {
        ...
        /// </summary>
        [WkHtmlSetting("web.background")]
        public bool? Background { get; set; }

        /// <summary>
        /// Should we load images. Default = true
        /// </summary>
        [WkHtmlSetting("web.loadImages")]
        public bool? LoadImages { get; set; }

        /// <summary>
        /// Should we enable javascript. Default = true
        /// </summary>
        [WkHtmlSetting("web.enableJavascript")]
